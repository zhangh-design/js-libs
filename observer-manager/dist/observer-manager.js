...
/* harmony import */ var lodash_isEqual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_isEqual__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash_bind__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26);
/* harmony import */ var lodash_bind__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_bind__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lodash_trim__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(41);
...
/* harmony import */ var lodash_set__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52);
...
/* harmony import */ var lodash_has__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(65);
...
/* harmony import */ var lodash_random__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(66);
...
/* harmony import */ var lodash_now__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(70);
...
/* harmony import */ var lodash_isNull__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(71);
...
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(72);
...
/* harmony import */ var lodash_find__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(74);
...
/* harmony import */ var lodash_forOwn__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(85);
/* harmony import */ var lodash_forOwn__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(lodash_forOwn__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var lodash_isEmpty__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(90);
...
/* harmony import */ var lodash_forOwnRight__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(94);
/* harmony import */ var lodash_forOwnRight__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(lodash_forOwnRight__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var lodash_isUndefined__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(97);
...
/* harmony import */ var lodash_pick__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(98);
...
/* harmony import */ var lodash_keys__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(81);
...
const ObserverManager = class Observer {
  ...
  deconstructEventConfigModule (userEventConfigModuleList = {}) {
    lodash_forOwn__WEBPACK_IMPORTED_MODULE_10___default()(userEventConfigModuleList, (module, key) => {
      lodash_forOwn__WEBPACK_IMPORTED_MODULE_10___default()(module, eventValue => {
        if (lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(eventValue, 'name') && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(eventValue, 'name')), false) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(this.eventModules.has(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(eventValue, 'name')), false)) {
          this.eventModules.set(`${key}/${lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(eventValue, 'name')}`, eventValue)
        }
      })
    })
  }
  ...
  add (name = '', handler = function () {}, fireScope = null, handlerScope = null, ...data) {
    if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_trim__WEBPACK_IMPORTED_MODULE_2___default()(name), '') || lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(name) || lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(this.eventModules.has(name), false)) {
      return
    }
    const firingEvent = lodash_find__WEBPACK_IMPORTED_MODULE_9___default()(this.fireEvents, (elem) => {
      return lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(elem, name) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireScope, 'eventIdentity', null), lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(elem, 'eventIdentity'))
    })
    if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_isUndefined__WEBPACK_IMPORTED_MODULE_13___default()(firingEvent), false)) {
      // @ts-ignore
      lodash_bind__WEBPACK_IMPORTED_MODULE_1___default()(handler, handlerScope, ...data)(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(firingEvent, 'data', []))
    }
    if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(fireScope, 'eventIdentity'), false)) {
      lodash_set__WEBPACK_IMPORTED_MODULE_3___default()(fireScope, 'eventIdentity', `${lodash_now__WEBPACK_IMPORTED_MODULE_6___default()()}-${lodash_random__WEBPACK_IMPORTED_MODULE_5___default()(1, 10000)}`)
    }
    // @ts-ignore
    this.addEvents.push({ [name]: function () { return lodash_bind__WEBPACK_IMPORTED_MODULE_1___default()(handler, handlerScope, ...data) }, eventIdentity: lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireScope, 'eventIdentity'), uuid: lodash_random__WEBPACK_IMPORTED_MODULE_5___default()(2, 100), once: false })
  }
  ...
  addOnce (name = '', handler = function () {}, fireScope = null, handlerScope = null, ...data) {
    ...
    // @ts-ignore
    this.addEvents.push({ [name]: function () { return lodash_bind__WEBPACK_IMPORTED_MODULE_1___default()(handler, handlerScope, ...data) }, 'eventIdentity': lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireScope, 'eventIdentity'), uuid: lodash_random__WEBPACK_IMPORTED_MODULE_5___default()(2, 100), once: true })
  }
  ...
  fire (name = '', fireScope = null, data) {
    if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_trim__WEBPACK_IMPORTED_MODULE_2___default()(name), '') || lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(name) || lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(this.eventModules.has(name), false) || lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireScope, 'eventIdentity', null))) {
      return
    }
    for (const [index, elem] of this.fireEvents.entries()) {
      if (lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(elem, name) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireScope, 'eventIdentity', null), lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(elem, 'eventIdentity')) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(elem, 'once', false), false)) {
        this.fireEvents.splice(index, 1)
      }
    }
    const fireData = lodash_pick__WEBPACK_IMPORTED_MODULE_14___default()(data, lodash_keys__WEBPACK_IMPORTED_MODULE_15___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(this.eventModules.get(name), 'fireData', {})))
    const firingEvents = []
    for (const addEvent of this.addEvents.values()) {
      const onceEvent = lodash_find__WEBPACK_IMPORTED_MODULE_9___default()(this.fireEvents, (fireEvent) => {
        return lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireEvent, name), lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(addEvent, name)) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireEvent, 'eventIdentity', null), lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(addEvent, 'eventIdentity')) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(addEvent, 'once', false), true)
      })
      if (lodash_isUndefined__WEBPACK_IMPORTED_MODULE_13___default()(onceEvent)) {
        if (lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(addEvent, name) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireScope, 'eventIdentity', null), lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(addEvent, 'eventIdentity'))) {
          firingEvents.push(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(addEvent, name))
          this.fireEvents.push(lodash_set__WEBPACK_IMPORTED_MODULE_3___default()(addEvent, 'data', fireData))
        }
      }
    }
    if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_isEmpty__WEBPACK_IMPORTED_MODULE_11___default()(firingEvents), false)) {
      const order = lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(this.eventModules.get(name), 'order', 'desc')
      if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(order, 'asc')) {
        lodash_forOwn__WEBPACK_IMPORTED_MODULE_10___default()(firingEvents, event => event()(fireData))
      }
      if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(order, 'desc')) {
        lodash_forOwnRight__WEBPACK_IMPORTED_MODULE_12___default()(firingEvents, event => event()(fireData))
      }
    }
  }
  ...
  off (name = '', fireScope = null) {
    if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_trim__WEBPACK_IMPORTED_MODULE_2___default()(name), '') || lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(name) || lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(fireScope) || lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(fireScope, 'eventIdentity'), false)) {
      return
    }
    for (const [index, elem] of this.fireEvents.entries()) {
      if (lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(elem, name) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default()(lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(fireScope, 'eventIdentity', null), lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(elem, 'eventIdentity'))) {
        this.fireEvents.splice(index, 1)
      }
    }
...
var baseRest = __webpack_require__(27),
    createWrap = __webpack_require__(32),
...
var baseToString = __webpack_require__(42),
    castSlice = __webpack_require__(43),
    charsEndIndex = __webpack_require__(45),
    charsStartIndex = __webpack_require__(46),
...
var baseRandom = __webpack_require__(67),
    isIterateeCall = __webpack_require__(68),
    toFinite = __webpack_require__(69);
...
var baseForOwnRight = __webpack_require__(95),
    castFunction = __webpack_require__(89);
...
var baseForRight = __webpack_require__(96),
    keys = __webpack_require__(81);
