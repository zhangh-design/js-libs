...
/* harmony import */ var _babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_object_entries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(85);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(90);
...
/* harmony import */ var _babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(107);
...
/* harmony import */ var _babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(108);
...
/* harmony import */ var lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(113);
...
/* harmony import */ var lodash_trim__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(118);
...
/* harmony import */ var lodash_isNull__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(130);
...
/* harmony import */ var lodash_isEqual__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(131);
...
/* harmony import */ var lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(153);
...
var GlobalVar = /*#__PURE__*/function () {
  function Global() {
    var globalVarObject = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, Global);
     ...
     * @default
     */
    this.globalVarMap = new _babel_runtime_corejs3_core_js_stable_map__WEBPACK_IMPORTED_MODULE_2___default.a();
  ...
  _babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Global, [{
    key: "init",
    value: function init() {
      var globalVarObject = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      if (lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_5___default()(globalVarObject) && lodash_isEqual__WEBPACK_IMPORTED_MODULE_8___default()(lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9___default()(globalVarObject), false)) {
        for (var _i = 0, _Object$entries = _babel_runtime_corejs3_core_js_stable_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(globalVarObject); _i < _Object$entries.length; _i++) {
          var _Object$entries$_i = _babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_Object$entries[_i], 2),
              key = _Object$entries$_i[0],
              value = _Object$entries$_i[1];

          if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_8___default()(lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(key), false)) {
            this.globalVarMap.set(lodash_trim__WEBPACK_IMPORTED_MODULE_6___default()(key), value);
          }
        }
      }
    }
    ...
    */
    ...
    value: function getValue() {
      ...
      if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_8___default()(lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(key), false) && this.globalVarMap.has(lodash_trim__WEBPACK_IMPORTED_MODULE_6___default()(key))) {
        return this.globalVarMap.get(lodash_trim__WEBPACK_IMPORTED_MODULE_6___default()(key));
      }
    ...
    */
    ...
    value: function addOrUpdate() {
      ...
      if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_8___default()(lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(key), false)) {
        this.globalVarMap.set(lodash_trim__WEBPACK_IMPORTED_MODULE_6___default()(key), lodash_trim__WEBPACK_IMPORTED_MODULE_6___default()(value));
      }
    }
    /**
    * @desc 删除某个key对应的全局变量
    ...
    */
    ...
    value: function evict() {
      ...
      if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_8___default()(lodash_isNull__WEBPACK_IMPORTED_MODULE_7___default()(key), false) && this.globalVarMap.has(lodash_trim__WEBPACK_IMPORTED_MODULE_6___default()(key))) {
        this.globalVarMap["delete"](lodash_trim__WEBPACK_IMPORTED_MODULE_6___default()(key));
      }
    }
    /**
    * @desc 清空所有全局变量
...
var _Array$isArray = __webpack_require__(3);
...
var _isIterable = __webpack_require__(81);
...
var $ = __webpack_require__(7);
var createIteratorConstructor = __webpack_require__(50);
...
var IS_PURE = __webpack_require__(46);
var Iterators = __webpack_require__(38);
var IteratorsCore = __webpack_require__(51);
...
var IteratorPrototype = __webpack_require__(51).IteratorPrototype;
...
var sharedKey = __webpack_require__(44);
var CORRECT_PROTOTYPE_GETTER = __webpack_require__(54);
...
var $ = __webpack_require__(7);
var $entries = __webpack_require__(89).entries;
...
var collection = __webpack_require__(94);
...
var baseToString = __webpack_require__(119),
    castSlice = __webpack_require__(120),
    charsEndIndex = __webpack_require__(122),
    charsStartIndex = __webpack_require__(124),
...
var asciiToArray = __webpack_require__(126),
    ...
    unicodeToArray = __webpack_require__(128);
